...
namespace AP_Proto.Views.Manager
{
    public class ManagerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fname,Sname,Email,Tel")] ContactModel contactModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fname,Sname,Email,Tel")] ContactModel contactModel)
        {
